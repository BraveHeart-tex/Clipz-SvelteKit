<script lang="ts">
  ...
  function markAsRead() {
    const newNotifications = $notificationsStore.notifications.filter(
...
<div
  ...
  class="bg-surface-100 dark:bg-surface-700 p-3 rounded-md shadow-md w-full cursor-pointer hover:bg-surface-200 transition-all dark:hover:bg-surface-500"
>
